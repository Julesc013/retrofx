...
def main(argv: list[str] | None = None) -> int:
    ...
    _add_passthrough_command(subparsers, "preview-x11", "Run the bounded X11 render preview surface. This remains explicit, internal-only, and not broader-alpha ready.")
    ...
    _add_passthrough_command(subparsers, "package-alpha", "Build one reproducible internal-alpha or local-candidate package around a deterministic 2.x bundle. This is not a broader-alpha package flow.")
    _add_passthrough_command(subparsers, "diagnostics", "Capture a local TWO-28 diagnostics directory for internal alpha or local-candidate triage.")
