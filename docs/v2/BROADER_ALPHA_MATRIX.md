...
This matrix records the broader-alpha-oriented validation pass for TWO-28.
...
- `./v2/tests/test.sh`
- TWO-28 scenario reruns under `/tmp/retrofx-v2-two28-*`
- current tagged internal candidate `v2.0.0-alpha.internal.1`
...
The immediate value of TWO-28 is not new capability.
It is clearer classification of what should remain internal-only and what still blocks broader alpha.
