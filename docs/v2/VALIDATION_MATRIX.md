...
| full 2.x test suite | repo-local dev | `./v2/tests/test.sh` | full suite passes | `Ran 134 tests in 1.749s` and `OK` | pass | Automated coverage still matches the current branch state after the TWO-25 controlled-alpha operations additions. |
