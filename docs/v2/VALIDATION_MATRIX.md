...
| full 2.x test suite | repo-local dev | `./v2/tests/test.sh` | full suite passes | `Ran 143 tests in 2.754s` and `OK` | pass | Automated coverage still matches the current branch state after the TWO-32 technical-beta candidate preparation pass. |
