...
- [PUBLIC_BETA_RISK_SURFACE.md](PUBLIC_BETA_RISK_SURFACE.md), [PUBLIC_BETA_GATES.md](PUBLIC_BETA_GATES.md), [PUBLIC_BETA_BLOCKERS.md](PUBLIC_BETA_BLOCKERS.md), and [PUBLIC_BETA_READINESS.md](PUBLIC_BETA_READINESS.md) now define the limited public technical beta gate and keep the branch positioned as internal-only
- [TECHNICAL_BETA_NOTES.md](TECHNICAL_BETA_NOTES.md) and [TECHNICAL_BETA_CHECKLIST.md](TECHNICAL_BETA_CHECKLIST.md) now exist as preparatory outside-tester docs without approving publication
...
- no limited public technical beta is approved; public-facing docs are preparatory only and the branch remains internal-only
