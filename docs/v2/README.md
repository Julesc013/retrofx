...
15. [IMPLEMENTED_STATUS.md](IMPLEMENTED_STATUS.md), [IMPLEMENTED_INTERFACES.md](IMPLEMENTED_INTERFACES.md), [VALIDATION_MATRIX.md](VALIDATION_MATRIX.md), [BROADER_ALPHA_MATRIX.md](BROADER_ALPHA_MATRIX.md), [ALPHA_BLOCKERS.md](ALPHA_BLOCKERS.md), [PRE_BETA_BLOCKERS.md](PRE_BETA_BLOCKERS.md), [PUBLIC_BETA_RISK_SURFACE.md](PUBLIC_BETA_RISK_SURFACE.md), [PUBLIC_BETA_GATES.md](PUBLIC_BETA_GATES.md), [PUBLIC_BETA_BLOCKERS.md](PUBLIC_BETA_BLOCKERS.md), [PUBLIC_BETA_READINESS.md](PUBLIC_BETA_READINESS.md), [TECHNICAL_BETA_NOTES.md](TECHNICAL_BETA_NOTES.md), [TECHNICAL_BETA_CHECKLIST.md](TECHNICAL_BETA_CHECKLIST.md), [TECHNICAL_BETA_CANDIDATE_NOTES.md](TECHNICAL_BETA_CANDIDATE_NOTES.md), [TECHNICAL_BETA_CANDIDATE_SUMMARY.md](TECHNICAL_BETA_CANDIDATE_SUMMARY.md), [TECHNICAL_BETA_RELEASE_CHECKLIST.md](TECHNICAL_BETA_RELEASE_CHECKLIST.md), [TECHNICAL_BETA_EXECUTION_PLAN.md](TECHNICAL_BETA_EXECUTION_PLAN.md), [TECHNICAL_BETA_ENVIRONMENT_REPORT_TEMPLATE.md](TECHNICAL_BETA_ENVIRONMENT_REPORT_TEMPLATE.md), [TECHNICAL_BETA_FEEDBACK_TEMPLATE.md](TECHNICAL_BETA_FEEDBACK_TEMPLATE.md), [TECHNICAL_BETA_ISSUE_TEMPLATE.md](TECHNICAL_BETA_ISSUE_TEMPLATE.md), [TECHNICAL_BETA_TRIAGE.md](TECHNICAL_BETA_TRIAGE.md), [TECHNICAL_BETA_MATRIX.md](TECHNICAL_BETA_MATRIX.md), [TECHNICAL_BETA_BLOCKERS.md](TECHNICAL_BETA_BLOCKERS.md), [TECHNICAL_BETA_READINESS.md](TECHNICAL_BETA_READINESS.md), [ALPHA_REMEDIATION_BACKLOG.md](ALPHA_REMEDIATION_BACKLOG.md), [ALPHA_READINESS.md](ALPHA_READINESS.md), [BROADER_ALPHA_READINESS.md](BROADER_ALPHA_READINESS.md), [PRE_BETA_READINESS.md](PRE_BETA_READINESS.md), [PRE_BETA_CANDIDATE_NOTES.md](PRE_BETA_CANDIDATE_NOTES.md), [PRE_BETA_CANDIDATE_SUMMARY.md](PRE_BETA_CANDIDATE_SUMMARY.md), [PRE_BETA_RELEASE_CHECKLIST.md](PRE_BETA_RELEASE_CHECKLIST.md), [PRE_BETA_GATES.md](PRE_BETA_GATES.md), [NEXT_STAGE_VERDICT.md](NEXT_STAGE_VERDICT.md), [ALPHA_VERSIONING.md](ALPHA_VERSIONING.md), [EXPERIMENTAL_STATUS.md](EXPERIMENTAL_STATUS.md), [CONTROLLED_ALPHA_PLAN.md](CONTROLLED_ALPHA_PLAN.md), [ALPHA_TRIAGE.md](ALPHA_TRIAGE.md), [ALPHA_EXECUTION_CHECKLIST.md](ALPHA_EXECUTION_CHECKLIST.md), [ALPHA_ENVIRONMENT_REPORT_TEMPLATE.md](ALPHA_ENVIRONMENT_REPORT_TEMPLATE.md), [ALPHA_FEEDBACK_TEMPLATE.md](ALPHA_FEEDBACK_TEMPLATE.md), [ALPHA_ISSUE_TEMPLATE.md](ALPHA_ISSUE_TEMPLATE.md), [POST_ALPHA_DECISION_RULES.md](POST_ALPHA_DECISION_RULES.md), [ALPHA_CANDIDATE_NOTES.md](ALPHA_CANDIDATE_NOTES.md), [ALPHA_CANDIDATE_SUMMARY.md](ALPHA_CANDIDATE_SUMMARY.md), [ALPHA_RELEASE_CHECKLIST.md](ALPHA_RELEASE_CHECKLIST.md), [INTERNAL_ALPHA_RUNBOOK.md](INTERNAL_ALPHA_RUNBOOK.md), [INTERNAL_ALPHA_NOTES.md](INTERNAL_ALPHA_NOTES.md), [DEV_WORKFLOW.md](DEV_WORKFLOW.md), [ROADMAP.md](ROADMAP.md), [STABILIZATION_PLAN.md](STABILIZATION_PLAN.md), and [STABILIZATION_CHECKLIST.md](STABILIZATION_CHECKLIST.md) for current branch truth, remediation state, internal-alpha operations, broader-alpha and pre-beta gates, limited public technical-beta gating, candidate docs, technical-beta execution evidence, readiness decisions, developer entrypoints, phased delivery, and the stabilization handoff.
...
- `v2/session/dev/preview_x11_render.py` and `scripts/dev/retrofx-v2-preview-x11` now stage X11 render artifacts and can run an explicit short-lived `picom` probe in X11; that bounded probe has one real X11 plus `i3` validation run and remains internal-only rather than broader-alpha ready
...
- `scripts/dev/retrofx-v2 package-alpha` now builds a reproducible non-public internal-alpha package under `v2/releases/internal-alpha/<package-id>/`; it does not imply a broader-alpha or pre-beta package surface, and it now blocks dirty trees by default
- `scripts/dev/retrofx-v2 package-technical-beta` now builds a copied-toolchain limited technical-beta candidate package under `v2/releases/technical-beta/<package-id>/`
- `scripts/dev/retrofx-v2-techbeta` now provides the narrower advanced-tester-facing wrapper for the approved limited technical-beta surface
- `scripts/dev/retrofx-v2 package-alpha` now also rejects pre-beta, beta, or stable-looking version/status overrides so the internal package surface cannot mint misleading external-looking metadata
- `scripts/dev/retrofx-v2 diagnostics` now captures a local evidence directory with status, environment, source-control state, install-state, activation-state, and optional profile plus installed-bundle evidence for alpha triage
- `v2/dev/release.py` is now the code-side source of truth for the current internal-alpha version, historical local alpha candidate reference, and release-status metadata surfaced through `status`, `package-alpha`, and `diagnostics`
...
- [BROADER_ALPHA_MATRIX.md](BROADER_ALPHA_MATRIX.md), [BROADER_ALPHA_READINESS.md](BROADER_ALPHA_READINESS.md), [PRE_BETA_GATES.md](PRE_BETA_GATES.md), and [NEXT_STAGE_VERDICT.md](NEXT_STAGE_VERDICT.md) now record the broader-alpha gate and keep the branch positioned as internal-alpha only
- [PRE_BETA_BLOCKERS.md](PRE_BETA_BLOCKERS.md) and [PRE_BETA_READINESS.md](PRE_BETA_READINESS.md) now record the pre-beta gate and keep the branch positioned as an internal-alpha hardening build rather than a pre-beta candidate
- [PRE_BETA_CANDIDATE_NOTES.md](PRE_BETA_CANDIDATE_NOTES.md) and [PRE_BETA_RELEASE_CHECKLIST.md](PRE_BETA_RELEASE_CHECKLIST.md) now define the blocked non-public pre-beta candidate workflow explicitly instead of implying that the current branch can already take that step
- [PRE_BETA_CANDIDATE_SUMMARY.md](PRE_BETA_CANDIDATE_SUMMARY.md) now provides the concise operator summary for that still-blocked pre-beta candidate path
- [PUBLIC_BETA_RISK_SURFACE.md](PUBLIC_BETA_RISK_SURFACE.md), [PUBLIC_BETA_GATES.md](PUBLIC_BETA_GATES.md), [PUBLIC_BETA_BLOCKERS.md](PUBLIC_BETA_BLOCKERS.md), and [PUBLIC_BETA_READINESS.md](PUBLIC_BETA_READINESS.md) now define and approve the narrowed limited public technical beta gate
- [TECHNICAL_BETA_NOTES.md](TECHNICAL_BETA_NOTES.md), [TECHNICAL_BETA_CHECKLIST.md](TECHNICAL_BETA_CHECKLIST.md), [TECHNICAL_BETA_CANDIDATE_NOTES.md](TECHNICAL_BETA_CANDIDATE_NOTES.md), [TECHNICAL_BETA_CANDIDATE_SUMMARY.md](TECHNICAL_BETA_CANDIDATE_SUMMARY.md), and [TECHNICAL_BETA_RELEASE_CHECKLIST.md](TECHNICAL_BETA_RELEASE_CHECKLIST.md) now define the advanced-tester candidate workflow
- [TECHNICAL_BETA_EXECUTION_PLAN.md](TECHNICAL_BETA_EXECUTION_PLAN.md), [TECHNICAL_BETA_ENVIRONMENT_REPORT_TEMPLATE.md](TECHNICAL_BETA_ENVIRONMENT_REPORT_TEMPLATE.md), [TECHNICAL_BETA_FEEDBACK_TEMPLATE.md](TECHNICAL_BETA_FEEDBACK_TEMPLATE.md), [TECHNICAL_BETA_ISSUE_TEMPLATE.md](TECHNICAL_BETA_ISSUE_TEMPLATE.md), [TECHNICAL_BETA_TRIAGE.md](TECHNICAL_BETA_TRIAGE.md), [TECHNICAL_BETA_MATRIX.md](TECHNICAL_BETA_MATRIX.md), [TECHNICAL_BETA_BLOCKERS.md](TECHNICAL_BETA_BLOCKERS.md), and [TECHNICAL_BETA_READINESS.md](TECHNICAL_BETA_READINESS.md) now define and record the first limited technical-beta execution cycle
- [ALPHA_BLOCKERS.md](ALPHA_BLOCKERS.md) and [ALPHA_READINESS.md](ALPHA_READINESS.md) now record the current readiness decision: internal-use yes, controlled internal alpha yes, current alpha-candidate no, broader-alpha no
...
- [ALPHA_REMEDIATION_BACKLOG.md](ALPHA_REMEDIATION_BACKLOG.md), [ALPHA_CANDIDATE_NOTES.md](ALPHA_CANDIDATE_NOTES.md), [ALPHA_CANDIDATE_SUMMARY.md](ALPHA_CANDIDATE_SUMMARY.md), and [ALPHA_RELEASE_CHECKLIST.md](ALPHA_RELEASE_CHECKLIST.md) now define the first post-alpha remediation pass and the disciplined local-only alpha-candidate gate
- the historical local alpha candidate remains `v2.0.0-alpha.internal.1`, while the current branch version is `2.0.0-alpha.internal.2` and is treated as an untagged post-alpha hardening build
- the reserved non-public pre-beta candidate version is `2.0.0-prebeta.internal.1`, but that candidate is explicitly blocked and does not exist yet
- a limited public technical-beta candidate now exists as a narrower copied-toolchain surface, while the broader `retrofx-v2` developer surface remains internal-only
...
If you are evaluating the limited technical-beta candidate rather than the internal developer surface, use:
